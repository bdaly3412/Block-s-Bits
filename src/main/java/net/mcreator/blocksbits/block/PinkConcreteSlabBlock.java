...
public class PinkConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:pink_concrete_slab")
	public static final Block block = null;
	public PinkConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 13);
	}
