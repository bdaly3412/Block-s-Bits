...
public class LimeConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:lime_concrete_slab")
	public static final Block block = null;
	public LimeConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 12);
	}
