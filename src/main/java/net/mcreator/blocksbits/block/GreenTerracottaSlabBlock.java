...
public class GreenTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:green_terracotta_slab")
	public static final Block block = null;
	public GreenTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 34);
	}
