...
public class BlueTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:blue_terracotta_slab")
	public static final Block block = null;
	public BlueTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 31);
	}
