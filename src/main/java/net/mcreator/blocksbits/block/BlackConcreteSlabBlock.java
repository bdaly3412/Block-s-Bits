...
public class BlackConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:black_concrete_slab")
	public static final Block block = null;
	public BlackConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 4);
	}
