...
public class OrangeConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:orange_concrete_slab")
	public static final Block block = null;
	public OrangeConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 9);
	}
