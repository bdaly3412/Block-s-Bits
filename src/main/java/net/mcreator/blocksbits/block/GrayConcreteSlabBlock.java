...
public class GrayConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:gray_concrete_slab")
	public static final Block block = null;
	public GrayConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 14);
	}
