...
public class PurpleConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:purple_concrete_slab")
	public static final Block block = null;
	public PurpleConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 7);
	}
