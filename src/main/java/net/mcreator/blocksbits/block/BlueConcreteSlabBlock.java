...
public class BlueConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:blue_concrete_slab")
	public static final Block block = null;
	public BlueConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 5);
	}
