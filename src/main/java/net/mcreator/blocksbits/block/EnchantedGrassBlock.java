...
public class EnchantedGrassBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:enchanted_grass")
	public static final Block block = null;
	public EnchantedGrassBlock(BlocksBitsModElements instance) {
		super(instance, 39);
	}
