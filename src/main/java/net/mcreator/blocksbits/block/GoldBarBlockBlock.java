...
public class GoldBarBlockBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:gold_bar_block")
	public static final Block block = null;
	public GoldBarBlockBlock(BlocksBitsModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gold_bar_block");
		}
