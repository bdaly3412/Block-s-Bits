...
public class OrangeTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:orange_terracotta_slab")
	public static final Block block = null;
	public OrangeTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 21);
	}
