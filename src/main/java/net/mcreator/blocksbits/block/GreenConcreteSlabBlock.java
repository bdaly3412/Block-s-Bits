...
public class GreenConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:green_concrete_slab")
	public static final Block block = null;
	public GreenConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 17);
	}
