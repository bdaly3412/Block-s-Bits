...
public class MagentaConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:magenta_concrete_slab")
	public static final Block block = null;
	public MagentaConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 10);
	}
