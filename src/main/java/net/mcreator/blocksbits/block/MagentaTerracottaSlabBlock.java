...
public class MagentaTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:magenta_terracotta_slab")
	public static final Block block = null;
	public MagentaTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 22);
	}
