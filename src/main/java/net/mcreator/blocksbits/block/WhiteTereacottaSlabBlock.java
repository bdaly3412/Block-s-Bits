...
public class WhiteTereacottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:white_tereacotta_slab")
	public static final Block block = null;
	public WhiteTereacottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("white_tereacotta_slab");
		}
