...
public class LightBlueConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:light_blue_concrete_slab")
	public static final Block block = null;
	public LightBlueConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 8);
	}
