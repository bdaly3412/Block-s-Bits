...
public class GlowyGlowstoneBlockBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:glowy_glowstone_block")
	public static final Block block = null;
	public GlowyGlowstoneBlockBlock(BlocksBitsModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("glowy_glowstone_block");
		}
