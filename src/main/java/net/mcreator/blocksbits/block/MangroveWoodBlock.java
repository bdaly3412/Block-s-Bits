...
public class MangroveWoodBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:mangrove_wood")
	public static final Block block = null;
	public MangroveWoodBlock(BlocksBitsModElements instance) {
		super(instance, 41);
	}
