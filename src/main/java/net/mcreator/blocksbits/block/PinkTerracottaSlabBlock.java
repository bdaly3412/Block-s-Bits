...
public class PinkTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:pink_terracotta_slab")
	public static final Block block = null;
	public PinkTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 27);
	}
