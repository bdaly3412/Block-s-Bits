...
public class DarkStoneBrickSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:dark_stone_brick_slab")
	public static final Block block = null;
	public DarkStoneBrickSlabBlock(BlocksBitsModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_stone_brick_slab");
		}
