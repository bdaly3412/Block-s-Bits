...
public class PurpleTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:purple_terracotta_slab")
	public static final Block block = null;
	public PurpleTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_terracotta_slab");
		}
