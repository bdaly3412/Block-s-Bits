...
public class BrownConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:brown_concrete_slab")
	public static final Block block = null;
	public BrownConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 16);
	}
