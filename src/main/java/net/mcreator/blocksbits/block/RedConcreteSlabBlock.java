...
public class RedConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:red_concrete_slab")
	public static final Block block = null;
	public RedConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 18);
	}
