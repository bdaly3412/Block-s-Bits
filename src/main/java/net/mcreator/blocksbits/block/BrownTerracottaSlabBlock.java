...
public class BrownTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:brown_terracotta_slab")
	public static final Block block = null;
	public BrownTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 32);
	}
