...
public class YellowConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:yellow_concrete_slab")
	public static final Block block = null;
	public YellowConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 11);
	}
