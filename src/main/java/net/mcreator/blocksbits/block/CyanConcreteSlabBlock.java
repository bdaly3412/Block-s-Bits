...
public class CyanConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:cyan_concrete_slab")
	public static final Block block = null;
	public CyanConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 6);
	}
