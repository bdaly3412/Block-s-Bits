...
public class CyanTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:cyan_terracotta_slab")
	public static final Block block = null;
	public CyanTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 23);
	}
