...
public class YellowTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:yellow_terracotta_slab")
	public static final Block block = null;
	public YellowTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 25);
	}
