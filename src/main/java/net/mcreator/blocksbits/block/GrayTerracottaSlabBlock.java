...
public class GrayTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:gray_terracotta_slab")
	public static final Block block = null;
	public GrayTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 28);
	}
