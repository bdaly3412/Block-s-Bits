...
public class RedTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:red_terracotta_slab")
	public static final Block block = null;
	public RedTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("red_terracotta_slab");
		}
