...
public class LimeTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:lime_terracotta_slab")
	public static final Block block = null;
	public LimeTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 26);
	}
