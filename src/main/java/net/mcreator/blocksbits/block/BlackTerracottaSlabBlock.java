...
public class BlackTerracottaSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:black_terracotta_slab")
	public static final Block block = null;
	public BlackTerracottaSlabBlock(BlocksBitsModElements instance) {
		super(instance, 20);
	}
