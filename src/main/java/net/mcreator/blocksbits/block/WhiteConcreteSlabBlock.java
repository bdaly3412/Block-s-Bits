...
public class WhiteConcreteSlabBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:white_concrete_slab")
	public static final Block block = null;
	public WhiteConcreteSlabBlock(BlocksBitsModElements instance) {
		super(instance, 3);
	}
