...
public class EnderLampBlock extends BlocksBitsModElements.ModElement {
	@ObjectHolder("blocks__bits:ender_lamp")
	public static final Block block = null;
	public EnderLampBlock(BlocksBitsModElements instance) {
		super(instance, 38);
	}
